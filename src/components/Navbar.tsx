...
import { Menu, X, LogOut, Home, Info, Database, User as UserIcon } from "lucide-react";
    ...
    return (
        <>
            ...
            <nav className="bg-surface/90 backdrop-blur-md border-b border-outline-variant/30 sticky top-0 z-50 w-full h-20">
                <div className="max-w-[1280px] mx-auto px-[40px] flex justify-between items-center h-full">
                    {/* Logo */}
                    <Link
                        to="/"
