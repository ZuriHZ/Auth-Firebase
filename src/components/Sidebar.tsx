...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const navItems = [
    ...
    { name: "Documentación", path: "/docs", icon: BookOpen, adminOnly: false },
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:sticky top-0 left-0 z-50 h-screen bg-sidebar border-r border-sidebar-border flex flex-col shrink-0 ${
