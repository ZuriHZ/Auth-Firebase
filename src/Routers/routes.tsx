...
const Register = lazy(() => import("../components/Register.jsx").then(m => ({ default: m.Register })));
const Dashboard = lazy(() => import("../components/Dashboard.jsx").then(m => ({ default: m.Dashboard })));
const VerifyEmail = lazy(() => import("../context/VerifyEmail.jsx").then(m => ({ default: m.VerifyEmail })));
const PageNotFound = lazy(() => import("../pages/404.tsx").then(m => ({ default: m.PageNotFound })));
